...
class Roles(Resource):
    ...
    def __init__(self):
        ...
        self.config = {
            ...
            "Members": [
                {
                    "@odata.id": "/redfish/v1/RoleService/Roles/ReadOnly"
                },
                {
                    "@odata.id": "/redfish/v1/RoleService/Roles/Admin"
                },
                {
                    "@odata.id": "/redfish/v1/RoleService/Roles/IPMIAdmin"
                },
                {
                    "@odata.id": "/redfish/v1/RoleService/Roles/IPMIReadOnly"
                },
                {
                    "@odata.id": "/redfish/v1/RoleService/Roles/SNMPOnly"
                }
            ],
