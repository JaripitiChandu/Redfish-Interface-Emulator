...
class CiscoCollection(Resource):
    ...
    def __init__(self):
        ...
        self.config = {
            ...
            "Members": [
                {
                    "@odata.id": "/redfish/v1/Ciscoervice/Cisco/ReadOnly"
                },
                {
                    "@odata.id": "/redfish/v1/Ciscoervice/Cisco/Admin"
                },
                {
                    "@odata.id": "/redfish/v1/Ciscoervice/Cisco/IPMIAdmin"
                },
                {
                    "@odata.id": "/redfish/v1/Ciscoervice/Cisco/IPMIReadOnly"
                },
                {
                    "@odata.id": "/redfish/v1/Ciscoervice/Cisco/SNMPOnly"
                }
            ],
